...
function loadItems() {
    ...
    if (localStorage.getItem('caitems')) {
        ...
        $.each(caitems, function () {
            ...
            tr_html += '<td><input class="form-control text-center new_cost"  name="new_cost[]" type="text" value="' + formatMoney(item.row.new_cost) + '" data-id="' + row_no + '" data-item="' + item_id + '"  onClick="this.select();"></td>';
