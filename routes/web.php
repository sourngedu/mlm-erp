...
//for language tranlation route
  Route::group(['as'=>'admin.','prefix'=>'admin/','namespace'=>'Admin','middleware' =>['auth']],function (){
	...
	// User Role & Permission Route
        ...
        Route::get('/members/tree/{id}', 'MemberController@show_tree')->name('members.tree');
        Route::get('/chart', 'MemberController@chart')->name('chart');

        Route::get('/sponser', 'MemberController@sponser')->name('sponser');
