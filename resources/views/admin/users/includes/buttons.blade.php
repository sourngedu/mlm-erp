<div class="clearfix hidden-print ">
    ...
    <div class="btn-group pull-right">
        ...
        <ul class="dropdown-menu dropdown-info dropdown-menu-right">
            <li>
                <a  href="{{ route('admin.users.index') }}"><i class="fa fa-list" aria-hidden="true"></i>&nbsp;{{ucfirst(Request::segment(2))}} List</a>
            </li>

            <li>
                <a  href="{{ route('admin.users.create') }}"><i class="fa fa-plus" aria-hidden="true"></i>&nbsp;Create {{ucfirst(Request::segment(2))}}</a>
            </li>
            <li class="divider"></li>
                <li>
